...
public class ItemsModel implements Serializable, Parcelable
{
    ...
    public final static Creator<ItemsModel> CREATOR = new Creator<ItemsModel>() {
    ...
    ;
    private final static long serialVersionUID = 3150013879841090606L;
     ...
     * @param data
     */
    public ItemsModel(Boolean status, String message, Data data, Integer total) {
        super();
        this.status = status;
